...
@Service //cria um bin/instancia que é usado via injeção de dependencia
public class LeadServiceImpl implements LeadService {
    ...
    @Autowired
    public LeadServiceImpl(LeadRepository leadRepository, UserRepository userRepository, ModelMapper modelMapper) {
    ...
    @Override
    public LeadDTO create(CreateLeadDTO leadDTO) {
